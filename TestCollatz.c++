...
struct TestCollatz : CppUnit::TestFixture {
	...
	void test_cycle_10 () {
		...
		const int v = cycle(main_cache, cache_size, 10);
		CPPUNIT_ASSERT_EQUAL_MESSAGE("", 7, v);
	}
	...
	void test_cycle_20 () {
		...
		const int v = cycle(main_cache, cache_size, 20);
		CPPUNIT_ASSERT_EQUAL_MESSAGE("", 8, v);
	}
	...
	void test_cycle_one() {
		...
		const int v = cycle(main_cache, cache_size, 1);
		CPPUNIT_ASSERT_EQUAL_MESSAGE("", 1, v);
	}
